# Data Science Python Project 20
...
# Questions
* Senaryo:
    Walter White, Jesse Pinkman ve diğer karakterlerin yer aldığı istatistiksel bir analiz projesi hazırlıyoruz. Elimizde çeşitli sahnelerdeki olay süreleri, öldürülen kişi sayıları, laboratuvar üretim kapasiteleri gibi sayısal veriler var. Bu verilerle karakterler veya sezonlar arasında anlamlı fark olup olmadığını test edeceğiz.
